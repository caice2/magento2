<?php
namespace OmniPro\Prueba\Ui\Component\Listing\Column;
        ...
        if(isset($dataSource['data']['items'])) {
            foreach($dataSource['data']['items'] as &$item)
            {
                $item[$this->getData('name')]['edit'] = [
                    'href' => $this->urlBuilder->getUrl('blogs/prueba/save/', ['id' => $item['id']]),
                    'label' => __('Edit'),
                    'hidden' => false
                ];
                $item[$this->getData('name')]['delete'] = [
                    'href' => $this->urlBuilder->getUrl('blogs/index/delete', ['id' => $item['id']]),
                    'label' => __('Delete'),
                    'hidden' => false
                ];
            }
